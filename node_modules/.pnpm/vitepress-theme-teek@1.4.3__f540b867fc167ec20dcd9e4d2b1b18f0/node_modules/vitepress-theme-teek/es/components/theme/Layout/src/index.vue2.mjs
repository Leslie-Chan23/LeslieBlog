import { defineComponent, provide, computed, watch, createElementBlock, createBlock, unref, openBlock, Fragment, renderSlot, createCommentVNode, createVNode, createSlots, renderList, withCtx, normalizeProps, guardReactiveProps, normalizeClass, resolveDynamicComponent, mergeProps } from 'vue';
...
import _sfc_main$v from '../../Home/src/index.vue2.mjs';
...
import _sfc_main$l from '../../ArticleImagePreview/src/index.vue2.mjs';
import _sfc_main$k from '../../ArticleAnalyze/src/index.vue2.mjs';
...
import _sfc_main$m from '../../ArticlePageStyle/src/index.vue2.mjs';
...
import _sfc_main$n from '../../CodeBlockToggle/src/index.vue2.mjs';
import _sfc_main$a from '../../RightBottomButton/src/index.vue2.mjs';
import _sfc_main$9 from '../../Notice/src/index.vue2.mjs';
import _sfc_main$t from '../../ThemeEnhance/src/index.vue2.mjs';
import _sfc_main$o from '../../../common/VpContainer/src/index.vue2.mjs';
...
import _sfc_main$u from '../../HomeFeature/src/index.vue2.mjs';
import _sfc_main$b from '../../RouteLoading/src/index.vue.mjs';
        ...
        [
          ...
          unref(frontmatter).layout !== false ? (openBlock(), createElementBlock(
            ...
            [
              ...
              unref(teekConfig).loading ?? false ? (openBlock(), createBlock(unref(_sfc_main$b), { key: 2 }, {
          ...
          createVNode(unref(Layout), {
            ...
            "layout-bottom": withCtx(() => [
              unref(isHomePage) ? (openBlock(), createBlock(unref(_sfc_main$r), { key: 0 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-footer-info-before"),
              unref(isHomePage) ? (openBlock(), createBlock(unref(_sfc_main$s), { key: 1 })) : createCommentVNode("v-if", true),
            ...
            "doc-before": withCtx(() => [
              ...
              unref(frontmatter).article !== false ? (openBlock(), createBlock(unref(_sfc_main$k), { key: 0 })) : createCommentVNode("v-if", true),
            ...
            "doc-after": withCtx(() => [
              ...
              (unref(teekConfig).articleUpdate.enabled ?? true) && unref(frontmatter).articleUpdate !== false ? (openBlock(), createBlock(unref(_sfc_main$h), { key: 0 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-doc-update-after"),
              renderSlot(_ctx.$slots, "teek-doc-after-appreciation-before"),
              unref(teekConfig).appreciation.position === "doc-after" ? (openBlock(), createBlock(unref(_sfc_main$i), { key: 1 })) : unref(teekConfig).appreciation.position === "doc-after-popper" ? (openBlock(), createBlock(unref(_sfc_main$j), { key: 2 })) : createCommentVNode("v-if", true),
            ...
            "aside-bottom": withCtx(() => [
              ...
              unref(teekConfig).appreciation.position === "aside-bottom" ? (openBlock(), createBlock(unref(_sfc_main$g), { key: 0 })) : createCommentVNode("v-if", true),
            ...
            "aside-outline-before": withCtx(() => [
              ...
              unref(teekConfig).articleShare.enabled ? (openBlock(), createBlock(unref(_sfc_main$c), { key: 0 })) : createCommentVNode("v-if", true),
