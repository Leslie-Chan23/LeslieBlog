import { defineComponent, computed, onMounted, createElementBlock, openBlock, unref, normalizeClass, createCommentVNode, renderSlot, createElementVNode, normalizeProps, mergeProps, Fragment, toDisplayString, withDirectives, vShow } from 'vue';
        ...
        createElementVNode("p", {
          ...
          isDefaultDescStyle.value ? (openBlock(), createElementBlock(
            ...
            [
              ...
              }, toDisplayString(unref(text)), 9, _hoisted_5), [
                [vShow, unref(text)]
              ]),
